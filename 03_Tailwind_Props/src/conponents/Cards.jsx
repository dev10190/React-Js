...
const Cards = ({username, price='00'}) => {



  return (
    <div className="flex font-sans mt-5">
    <div className="flex-none w-56 relative">
      <img
        src="https://images.pexels.com/photos/6062045/pexels-photo-6062045.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
        alt=""
    ...
    <form className="flex-auto p-6">
      <div className="flex flex-wrap">
        <h1 className="flex-auto font-medium text-slate-900">{username}</h1>
